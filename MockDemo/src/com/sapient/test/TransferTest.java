...
public class TransferTest {
	...
	public static void beforeAll(){
		...
		acc3 = new Account(1003, "sam", 3000);
	...
	@Test
	public void testFund1() throws BalanceException, IdException{
		assumeTrue(ser!=null);
	...
	@Test
	public void testFund2() throws BalanceException, IdException{
		assumeTrue(ser!=null);
		assertThrows(BalanceException.class, ()->ser.transferFund(1003, 1002, 5000));
	}
	@Test
	public void testFund3() throws BalanceException, IdException{
		assumeTrue(ser!=null);
